...
class SelecaoTurnoActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val turnos = listOf("MANHA", "TARDE", "NOITE")
    ...
    private fun calcularDiaSemana(data: String): String {
        return try {
            ...
            val date = formato.parse(data) ?: return ""

            val diaSemanaNumero = SimpleDateFormat("u", Locale.getDefault())
                .format(date)
                .toInt()

            when (diaSemanaNumero) {
                1 -> "SEGUNDA"
                2 -> "TERCA"
                3 -> "QUARTA"
                4 -> "QUINTA"
